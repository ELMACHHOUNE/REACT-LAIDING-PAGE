            ...
            <footer className="bg-white">
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <div className="text-blue-600">
                        <img className="h-20 w-40" src="logo.png" />
                    </div>

                    <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        <div className="col-span-2">
                        <div>
                            <h2 className="text-blue-600">boutique d'électronique</h2>
                        ...
                        <form className="w-full">
                            ...
                            <input
                                type="email"
                                id="UserEmail"
                                placeholder="contact@electronix.fr"
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                            <a href="#home" className="text-blue-700 transition hover:opacity-75"> Home </a>
                            </li>
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                            <a href="#about" className="text-blue-700 transition hover:opacity-75"> About </a>
                            </li>
                        </ul>
                        </div>
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                            <a href="#product" className="text-blue-700 transition hover:opacity-75"> Product </a>
                            </li>
                        </ul>
                        </div>
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            <li>
                            <a href="#contact" className="text-blue-700 transition hover:opacity-75"> Contact </a>
                            </li>
                        </ul>
                        </div>
